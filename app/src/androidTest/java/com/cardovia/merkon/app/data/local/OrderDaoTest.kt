...
class OrderDaoTest {
    ...
    // Datos de prueba
    private val sampleItem = com.cardovia.merkon.app.data.model.ConfiguredProduct(
    ...
    private val sampleEntity = OrderEntity(
        id        = 1L,
        itemsJson = com.cardovia.merkon.app.data.local.ConfiguredProductTypeConverter.fromList(listOf(sampleItem)),
        total     = java.math.BigDecimal("158.0"),
    ...
    fun cartItemTypeConverter_serializesAndDeserializesCorrectly() = runTest {
        ...
        val found = dao.getOrderById(1L)!!
        val items = com.cardovia.merkon.app.data.local.ConfiguredProductTypeConverter.toList(found.itemsJson)
