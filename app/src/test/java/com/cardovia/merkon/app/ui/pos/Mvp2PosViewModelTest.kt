...
import com.cardovia.merkon.app.data.model.DefaultComponentResponse
import com.cardovia.merkon.app.data.model.OpenSaleRequest
import com.cardovia.merkon.app.data.model.OpenSaleResponse
...
class Mvp2PosViewModelTest {
    ...
    fun setUp() {
        ...
        val printManager = mockk<com.cardovia.merkon.app.PrintManager>(relaxed = true)
        val printJobRepository = mockk<com.cardovia.merkon.app.data.repository.IPrintJobRepository>(relaxed = true)
