...
import com.cardovia.merkon.app.data.model.OperationalOrderLineDto
...
class PrintServiceTest {
            ...
            lines = listOf(
                OperationalOrderLineDto(
                    ...
                    configuration = listOf(
                        com.cardovia.merkon.app.data.model.OrderConfigurationSnapshotDto(
                            id = 1L,
    ...
    private fun createBaseOrder(configList: List<com.cardovia.merkon.app.data.model.OrderConfigurationSnapshotDto>): OperationalOrderDetailDto {
    ...
    fun `settled ON_DELIVERY CARD prints actual CARD and modality`() {
        val detail = buildOnDeliveryDetail(
            requiresPaymentCollection = false,
            paymentMethod = com.cardovia.merkon.app.data.model.PaymentMethod.CARD,
            paymentCollectedAt = java.time.Instant.now(),
            paymentCollectedByUserId = 1L
        )
        val ctx = mockk<android.content.Context>(relaxed = true)
    ...
    fun `IMMEDIATE PICKUP CASH print remains unchanged`() {
        val detail = OperationalOrderDetailDto(
            ...
            fulfillmentType = FulfillmentType.PICKUP,
            paymentMethod = com.cardovia.merkon.app.data.model.PaymentMethod.CASH,
            paymentTiming = com.cardovia.merkon.app.data.model.OrderPaymentTiming.IMMEDIATE,
            requiresPaymentCollection = false,
