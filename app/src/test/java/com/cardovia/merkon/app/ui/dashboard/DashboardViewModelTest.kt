package com.cardovia.merkon.app.ui.dashboard
...
class DashboardViewModelTest {
    ...
    fun setUp() {
        ...
        coEvery { repository.getOperationalAnalytics(any(), any()) } returns com.cardovia.merkon.app.data.model.HistoricalAnalyticsResponse(
