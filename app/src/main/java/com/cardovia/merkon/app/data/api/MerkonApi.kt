...
interface MerkonApi {
    ...
    suspend fun collectPayment(
        @Path("id") orderId: Long,
        @Body request: com.cardovia.merkon.app.data.model.OrderPaymentCollectionRequest
    ): Response<com.cardovia.merkon.app.data.model.OrderPaymentCollectionResponse>
    ...
    suspend fun createOpenSale(
        @Body request: com.cardovia.merkon.app.data.model.OpenSaleRequest
    ): Response<com.cardovia.merkon.app.data.model.OpenSaleResponse>
    ...
    suspend fun getMenuItemComponents(@Path("id") id: Long): Response<List<com.cardovia.merkon.app.data.model.DefaultComponentResponse>>
    ...
    suspend fun quoteMenuItem(
        @Path("id") id: Long,
        @Body request: com.cardovia.merkon.app.data.model.ItemQuoteRequestDto
    ): retrofit2.Response<com.cardovia.merkon.app.data.model.ItemQuoteResponseDto>
    ...
    suspend fun getMenuItemConfigurationDefinitionResponse(@Path("id") id: Long): Response<com.cardovia.merkon.app.data.model.MenuItemConfigurationDefinitionResponse>

    @POST("/api/v1/menu/items/{id}/selection-groups")
    suspend fun createSelectionGroup(
        @Path("id") itemId: Long,
        @Body request: com.cardovia.merkon.app.data.model.CreateMenuSelectionGroupRequest
    ): Response<com.cardovia.merkon.app.data.model.MenuSelectionGroupResponse>

    @PUT("/api/v1/menu/items/{id}/selection-groups/{groupId}")
    suspend fun updateSelectionGroup(
        @Path("id") itemId: Long,
        @Path("groupId") groupId: Long,
        @Body request: com.cardovia.merkon.app.data.model.UpdateMenuSelectionGroupRequest
    ): Response<com.cardovia.merkon.app.data.model.MenuSelectionGroupResponse>
    ...
    suspend fun createSelectionRule(
        @Path("groupId") groupId: Long,
        @Body request: com.cardovia.merkon.app.data.model.CreateMenuSelectionRuleRequest
    ): Response<com.cardovia.merkon.app.data.model.MenuSelectionRuleResponse>

    @PUT("/api/v1/menu/selection-groups/{groupId}/rules/{ruleId}")
    suspend fun updateSelectionRule(
        @Path("groupId") groupId: Long,
        @Path("ruleId") ruleId: Long,
        @Body request: com.cardovia.merkon.app.data.model.UpdateMenuSelectionRuleRequest
    ): Response<com.cardovia.merkon.app.data.model.MenuSelectionRuleResponse>
