package com.cardovia.merkon.app.ui.util
...
fun rememberBluetoothPermissionGateway(
    ...
    if (showDeniedDialog) {
        AlertDialog(
            ...
            text = { Text("Se necesita permiso para acceder a la impresora Bluetooth. Si el sistema ya no te lo pregunta, ve a Configuración -> Aplicaciones -> MerkON -> Permisos y habilita 'Dispositivos cercanos'.") },
            confirmButton = {
