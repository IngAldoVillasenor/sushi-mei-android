...
import com.cardovia.merkon.app.data.local.PrintJobDao
...
class RoomPrintJobRepository(private val dao: PrintJobDao) : IPrintJobRepository {
    ...
    override fun observeJobByDocument(documentType: com.cardovia.merkon.app.data.model.PrintDocumentType, documentId: Long): Flow<PrintJobEntity?> = dao.observeJobByDocument(documentType, documentId)
    ...
    override suspend fun getJobByDocument(documentType: com.cardovia.merkon.app.data.model.PrintDocumentType, documentId: Long): PrintJobEntity? = dao.getJobByDocument(documentType, documentId)
    ...
    override suspend fun ensureReprintReadyJob(
        ...
        val newJob = PrintJobEntity(
            ...
            status = com.cardovia.merkon.app.data.model.PrintJobStatus.REPRINT_READY,
            lastError = null,
