...
import com.cardovia.merkon.app.data.model.ItemQuoteResponseGroupDto

fun ItemQuoteResponseGroupDto.toDomain(): com.cardovia.merkon.app.data.model.ConfiguredGroup {
    return com.cardovia.merkon.app.data.model.ConfiguredGroup(
        groupId = this.groupId,
        name = this.name,
        selections = this.selections.map { selDto ->
            com.cardovia.merkon.app.data.model.ConfiguredSelection(
...
fun ConfiguratorScreen(
    ...
    onDismiss: () -> Unit,
    onAddToCart: (com.cardovia.merkon.app.data.model.ConfiguredProduct) -> Unit,
                    ...
                    Button(
                        onClick = {
                            uiState.latestQuote?.let { quote ->
                                val product = com.cardovia.merkon.app.data.model.ConfiguredProduct(
