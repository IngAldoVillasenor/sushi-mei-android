...
object NetworkModule {
    ...
    val merkonApi: MerkonApi by lazy {
        Retrofit.Builder()
            .baseUrl(BuildConfig.BASE_URL)
            .client(protectedOkHttpClient)
            .addConverterFactory(GsonConverterFactory.create(configuredGson))
            .build()
            .create(MerkonApi::class.java)
    }
}
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        try {
            val apiError = gson.fromJson(
                ...
                com.cardovia.merkon.app.data.model.ApiErrorDto::class.java
            )
            if (apiError != null) {
